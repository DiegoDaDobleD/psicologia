...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'es.dggc.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'es.dggc.UserRole'
grails.plugin.springsecurity.authority.className = 'es.dggc.Role'
